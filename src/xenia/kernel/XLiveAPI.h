...
class XLiveAPI {
 public:
  ...
  static std::unique_ptr<HTTPResponseObjectJSON> RegisterSdp(xe::be<uint16_t> port, std::string sdp);

  static std::string GetSdp(in_addr ip_addr, xe::be<uint16_t> port);
