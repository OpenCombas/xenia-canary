...
struct GENRES_ENUMERATE_RESPONSE {
  ...
  xe::be<int32_t> geners_total;
};
static_assert_size(GENRES_ENUMERATE_RESPONSE, 0xA);

struct GENRE_INFO {
  xe::be<int32_t> genre_id;
...
struct OFFER_PRICE {
  ...
  xe::be<int32_t> whole_price;
  xe::be<int32_t> fractional_price;
  xe::be<uint16_t> price_text_length;
  xe::be<uint32_t> price_text;
};
