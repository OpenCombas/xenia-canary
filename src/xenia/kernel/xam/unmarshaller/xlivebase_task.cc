...
XLIVEBASETASK::XLIVEBASETASK(uint32_t async_task_address)
...
void XLIVEBASETASK::PrintTaskInfo() {
  XELOGI(
      "\n***************** XLIVEBASE Task Info *****************\n"
      "SchemaVersionMajor: {}\n"
      "SchemaVersionMinor: {}\n"
...
bool XLIVEBASETASK::GetSchemaEntry(uint16_t schema_index,
...
bool XLIVEBASETASK::GetSchemaDataFromEntry(SCHEMA_TABLE_ENTRY* schema_entry_ptr,
                                           bool request,
...
bool XLIVEBASETASK::EndianBufferBind(BASE_ENDIAN_BUFFER* base,
...
bool XLIVEBASETASK::XLookupSchemaIndexFromOrdinal(
...
bool XLIVEBASETASK::LookupUrlFromTable(uint16_t url_index,
...
bool XLIVEBASETASK::LookupConstantFromTable(uint16_t constant_index,
                                            uint32_t* value_ptr) {
...
void XLIVEBASETASK::PrettyPrintSchemaTables() const {
...
void XLIVEBASETASK::PrettyPrintUrls() {
  const auto schema_table_entries = std::vector<SCHEMA_TABLE_ENTRY>(
      schema_table_entry_ptr_,
      schema_table_entry_ptr_ + schema_data_ptr_->Header.SchemaTableEntries);
...
void XLIVEBASETASK::PrettyPrintUrlsWithSchemaIndex() {
  const auto schema_table_entries = std::vector<SCHEMA_TABLE_ENTRY>(
      schema_table_entry_ptr_,
      schema_table_entry_ptr_ + schema_data_ptr_->Header.SchemaTableEntries);
...
void XLIVEBASETASK::PrettyPrintOrdinalToIndex() const {
  const auto ordinal_to_index_entries = std::vector<ORDINAL_TO_INDEX>(
      ordinal_to_index_ptr_,
      ordinal_to_index_ptr_ + schema_data_ptr_->Header.SchemaTableEntries);
...
XLIVE_ASYNC_TASK* XLIVEBASETASK::GetXLiveAsyncTask() {
  return xlive_async_task_ptr_;
}

SCHEMA_DATA* XLIVEBASETASK::GetSchemaData() { return schema_data_ptr_; }
