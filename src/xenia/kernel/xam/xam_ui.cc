...
bool xeDrawSessionContent(ui::ImGuiDrawer* imgui_drawer, UserProfile* profile,
...
class ShowCommunitySessionsUI : public XamDialog {
 public:
  ...
  virtual ~ShowCommunitySessionsUI() {}
...
dword_result_t XamShowCommunitySessionsUI_entry(dword_t user_index,
  ...
  auto close = [](ShowCommunitySessionsUI* dialog) -> void {};

  return xeXamDispatchDialogAsync<ShowCommunitySessionsUI>(
      new ShowCommunitySessionsUI(imgui_drawer, user), close);
}
